<template>
  ...
  >
    <div
      ...
      class="flex flex-col px-4 pb-4 rounded-2xl shadow-soft-xl border border-solid border-slate-50 dark:border-slate-800 bg-white dark:bg-slate-900 z-[1000] max-w-[720px] md:w-[20rem] lg:w-[24rem] xl:w-[28rem] 2xl:w-[32rem] h-[calc(100vh-20rem)] max-h-[40rem] animate-scale-in"
    >
      <search-header
