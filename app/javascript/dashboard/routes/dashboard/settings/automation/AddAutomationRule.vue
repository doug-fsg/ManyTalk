...
export default {
  ...
  computed: {
    ...
    filterAttributesForEvent() {
      return this.getAttributes(this.automationTypes, this.automation.event_name);
    },
  },
  async mounted() {
    await Promise.all([
    ...
    // Force reactivity update to ensure filterAttributes are available
    this.$forceUpdate();
  },
  methods: {
    getAttributes,
        ...
        <section>
          ...
          >
            <FilterInputBox
              ...
              :filter-attributes="filterAttributesForEvent"
              :input-type="
                getInputType(
                  allCustomAttributes,
                  automationTypes,
